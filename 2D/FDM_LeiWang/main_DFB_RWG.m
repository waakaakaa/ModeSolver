...
for i=1:n
    i
    %------------------------获得折射率分布矩阵---------------%
    [eeps,nx,ny,mStEnd] = GenerateEps(vThickness,vNeffAct,[twide,twide,twide,twide,vw(i),5e-6+vw(i),twide],1.55,twide,dx,dy);%取得左右对称的多层波导结构的折射率分布矩阵
